...
const ROLE_VIEWS: Record<StaffRole, AppView[]> = {
    ...
    cashier: ['pos', 'handheld', 'history', 'messages', 'stocktake', 'cash', 'profile', 'checklist'],
    chef: ['workstation', 'stocktake', 'profile', 'checklist'],
};
...
const VIEW_META: Record<AppView, NavItem> = {
    ...
    checklist: { id: 'checklist', icon: ClipboardCheck, label: 'Checklist', group: 'Operations' },
};
...
export function canAccessView(role: StaffRole | null, view: string, options: AccessOptions = {}) {
